select 
    ...
    select
        ...
        where pay_ok=1 and dt between '20190524' and '20190526' and qunar_username is not null and  qunar_username not in ('','NULL','null')
        group by qunar_username
    ) wide
    on t.qunar_username=wide.qunar_username 
    where wide.qunar_username is null
